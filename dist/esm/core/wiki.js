...
export function updateIndex(dir) {
...
export function updateLog(dir, action, description) {
...
export function ingest(rawFile, targetDir) {
    let content;
    try {
