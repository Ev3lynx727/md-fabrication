...
export function buildDepGraph(fragments) {
...
export function computeDagLevels(graph) {
...
export function splitTrilogy(fragments, order, graph) {
...
export function collectReferences(fragments) {
    const refs = [];
    const seen = new Set();
    for (const frag of fragments) {
...
export function extractTags(body, existingTags) {
...
export function generateAssembledFrontmatter(fragments, assembledBody) {
...
export function assembleFragments(fragments, order) {
...
export function enhanceTrilogy(parts, labels, filenames, contents) {
...
export function assembleTrilogy(fragments, order, graph, targetDir, hasExplicitVoice, profile, jsonOnly, dryRun, enhanceMode) {
